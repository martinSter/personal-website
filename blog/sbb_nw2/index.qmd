...
final_edges.remove(('Brig', 'Visp'))
final_edges.remove(('Etoy', 'Rolle'))
final_edges.remove(('Klosters Selfranga', 'Sagliains')) # Avoid several edges representing the Vereina tunnel
...
final_edges.append(('Brig', 'Eyholz')) # Connector that was missing
...
After these final modifications of the edgelist, the total number of edges is 1'707.
...
# Modify edges that exist in dict with exact distance.
final_edges = [(n1, n2, linien_edges_dict.get((n1, n2), dist)) for n1, n2, dist in final_edges]
```
...
edges = [[node_dict[e[0]], node_dict[e[1]], round(e[2], 4)] for e in final_edges]

# Create a dataframe
edges = pd.DataFrame(edges, columns = ['BPUIC1','BPUIC2','DISTANCE'])
